...
RSpec.describe Git::Repository::Configuring do
  ...
  describe '#global_config_get' do
    ...
    it 'emits a deprecation warning mentioning global_config_get' do
      expect(Git::Deprecation).to receive(:warn).with(/global_config_get/)
      result
    end
  ...
  describe '#global_config_list' do
    ...
    it 'emits a deprecation warning mentioning global_config_list' do
      expect(Git::Deprecation).to receive(:warn).with(/global_config_list/)
      result
    end
  ...
  describe '#global_config_set' do
    ...
    it 'emits a deprecation warning mentioning global_config_set' do
      expect(Git::Deprecation).to receive(:warn).with(/global_config_set/)
      result
    end
