...
module Test
  module Unit
    ...
    class TestCase
      ...
      DEFAULT_TEST_GIT_VERSION = '99.99.99'
      ...
      # Stub Git::Lib#git_version to avoid invoking the real git binary in tests.
      #
      # @param lib [Git::Lib] the lib instance to stub
      # @param version [String] the git version string to return
      ...
      # @return [void]
      #
      def assert_command_line_eq(expected_command_line, method: :command_capturing, mocked_output: '', include_env: false)
        ...
        in_temp_dir do |_path|
          ...
          facade_ec = git.send(:facade_repository).instance_variable_get(:@execution_context)
