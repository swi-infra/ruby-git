...
- Thoroughly document the new public API (`Git`, `Git::Repository`, etc.) and all of
  `lib/` to complete YARD/yardstick coverage.
...
met. In brief: yardstick coverage is at 100% across `lib/` with the CI floor set to
98%, `UPGRADING.md` covers all breaking changes, `README.md` reflects the new entry
points, and the full CI pipeline is green. This tracker defers to the Step C plan as
