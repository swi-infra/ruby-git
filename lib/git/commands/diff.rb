...
module Git
  module Commands
    ...
    #   Git::Commands::Diff.new(ctx).call('/path/a', '/path/b', patch: true, no_index: true)
    #
    ...
    class Diff < Git::Commands::Base
      ...
      #     @example
      #       # git diff --patch --no-index <path> <path>
      #       Diff.new(ctx).call('/path/a', '/path/b', patch: true, no_index: true)
      #
      ...
      #
      #     @option options [Boolean, Integer] :find_renames (nil) detect renames; optionally pass
      #       a similarity threshold (e.g., 50 for 50%). Alias: :M
      #
