...
module Git
  ...
  class Base
    ...
    def add_remote(name, url, opts = {})
      Git::Deprecation.warn(
        'Git::Base#add_remote is deprecated and will be removed in a future version. ' \
    ...
    def set_remote_url(name, url)
      Git::Deprecation.warn(
        'Git::Base#set_remote_url is deprecated and will be removed in a future version. ' \
    ...
    def remove_remote(name)
      Git::Deprecation.warn(
        'Git::Base#remove_remote is deprecated and will be removed in a future version. ' \
    ...
    def add_tag(name, *options)
      Git::Deprecation.warn(
        'Git::Base#add_tag is deprecated and will be removed in a future version. ' \
    ...
    def delete_tag(name)
      Git::Deprecation.warn(
        'Git::Base#delete_tag is deprecated and will be removed in a future version. ' \
