...
module Git
  ...
  class Branch
    ...
    #
    # @deprecated Use {Git::Repository#stashes_all} instead. This method ignores
    #   the branch receiver and returns every stash in the repository, so
    #   `git.branch('feature').stashes` and `git.branch('main').stashes` return
    #   the same entries.
    #
