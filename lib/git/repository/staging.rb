...
module Git
  class Repository
    ...
    module Staging
      ...
      ADD_ALLOWED_OPTS = %i[all force update].freeze
      ...
      #     files
      #
      #   @option options [Boolean] :update (false) update tracked files only;
      ...
      RESET_ALLOWED_OPTS = %i[soft mixed hard keep pathspec].freeze
      ...
      #
      #   @example Reset specific paths in the index
      #     repo.reset(nil, pathspec: ['README.md'])
      #
      ...
      #
      #   @option options [Boolean] :soft (false) leave working tree and index
      #     unchanged; reset HEAD only
      #
      #   @option options [Boolean] :mixed (false) reset the index but not the
      #     working tree (default mode)
      #
      #   @option options [Boolean] :hard (false) reset the index and working
      #     tree; discards all tracked changes
      #
      #   @option options [Boolean] :keep (false) reset index entries and update
      #     files that differ, aborting if any such file has local changes
      #
      #   @option options [Array<String>] :pathspec ([]) path(s) to reset in the
      #     index only
      #
