    ...
    module ObjectOperations # rubocop:disable Metrics/ModuleLength
      ...
      def add_tag(name, *options)
        Git::Deprecation.warn(
          'Git::Repository#add_tag is deprecated and will be removed in a future version. ' \
      ...
      def delete_tag(name)
        Git::Deprecation.warn(
          'Git::Repository#delete_tag is deprecated and will be removed in a future version. ' \
      ...
      module Private
        ...
        def tag_add_delete_deprecated(facade, name, target, opts)
          Git::Deprecation.warn(
            'Passing :d or :delete to tag_add is deprecated and will be ' \
            'removed in a future version. Use tag_delete instead.'
          )
