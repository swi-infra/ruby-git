...
module Git
  class Repository
    ...
    # supplied. {#config} targets the repository's local config; {#global_config}
    # targets the user's global config (`~/.gitconfig`).
    #
    ...
    module Configuring
      ...
      #
      # Dispatches to one of three modes depending on the arguments supplied,
      # targeting the user's global git config (`~/.gitconfig`):
      #
