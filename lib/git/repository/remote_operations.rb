    ...
    module RemoteOperations # rubocop:disable Metrics/ModuleLength
      ...
      def add_remote(name, url, opts = {})
        Git::Deprecation.warn(
          'Git::Repository#add_remote is deprecated and will be removed in a future version. ' \
      ...
      def remove_remote(name)
        Git::Deprecation.warn(
          'Git::Repository#remove_remote is deprecated and will be removed in a future version. ' \
      ...
      def set_remote_url(name, url)
        Git::Deprecation.warn(
          'Git::Repository#set_remote_url is deprecated and will be removed in a future version. ' \
