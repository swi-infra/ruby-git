...
module Git
  ...
  class SystemCallGuard
    ...
    #
    # If the block raises a `SystemCallError`, the enclosing {#call} re-raises it
    # unchanged. If the block completes, conversion resumes for the rest of the
    # enclosing {#call}.
    #
    # @return [Object] the value returned by the block
    #
